...
var rawcodeToName = map[uint16]string{
	...
	// X11: 26=E,41=F,42=G,43=H,44=J,57=N,33=P,24=Q,27=R,39=S,28=T,30=U,55=V,25=W,52=Z
	// 注: X11 的 53=X 与 macOS 的 53=escape 冲突，已按 macOS 优先原则去除
	...
	// 注: X11 的 111=up 与 macOS 的 111=F12 冲突，已按 macOS 优先原则去除
	113: "left", 114: "right", 116: "down",
}
