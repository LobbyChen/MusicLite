...
func NewHotkeyManager(app *App, player *Player) *HotkeyManager {
...
func (a *App) HotkeyFormatKey(keys string) string {
...
func (a *App) HotkeyParseFromJS(ctrl, shift, alt, meta bool, key string) string {
	var parts []string
	if ctrl {
...
func (a *App) HotkeyGetConfig() map[string]HotkeyConfig {
	if a.hotkeyManager == nil {
		return nil
	}
...
func (a *App) HotkeyGetActionList() []map[string]string {
